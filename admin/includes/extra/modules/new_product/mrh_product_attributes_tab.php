...
dcp288560004@www3118:~$
dcp288560004@www3118:~$ sed -n '1,500p' /home/www/doc/28856/dcp288560004/mr-hanf.at/www/admin_q9wKj6Ds/includes/extra/modules/new_product/mrh_product_attributes_tab.php
<?php
/**
 * MRH Product Attributes - categories.php Product Edit Hook
 * Autoinclude: ~/admin/includes/extra/modules/new_product/
                        ...
                        <div class="mrh-pa-field-input">
                            ...
                            <?php else: ?>
                                <input type="text"
                                       ...
                                       class="mrh-pa-input" data-field="<?php echo $field_key; ?>"
dcp288560004@www3118:~$
dcp288560004@www3118:~$ sed -n '501,1000p' /home/www/doc/28856/dcp288560004/mr-hanf.at/www/admin_q9wKj6Ds/includes/extra/modules/new_product/mrh_product_attributes_tab.php
                                       value="<?php echo htmlspecialchars($attrs[$field_key] ?? ''); ?>"
                                       placeholder="<?php echo htmlspecialchars($field_def['label']); ?>">
                            <?php endif; ?>
                        </div>
