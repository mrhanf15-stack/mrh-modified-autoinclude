...
(function(){
  ...
  // Detect browser preferred language (first 2 chars, e.g. "fr" from "fr-FR")
  ...
  // Use browser language if it differs from shop language and is available
  var useLang = detectedLang && detectedLang !== shopLang && translations[detectedLang] ? detectedLang : shopLang;
